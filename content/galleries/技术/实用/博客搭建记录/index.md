...
series:
  - 没什么用的记录
lastmod: 2025-06-03T02:09:07.621Z
---
## 前言
...
我选用的是[PaperMod](https://github.com/adityatelange/hugo-PaperMod)，去年第一次搭建博客的时候它并不是Hugo 官网主题的第一个，但现在已经放到HUgo官网主题的第一个了。（*笑，并不是我随大流，但是确实好用*）
